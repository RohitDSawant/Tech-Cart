import { Text, Image, Box, Input, Flex, Checkbox, Spacer, Icon, Button, Stack, Heading, Select } from "@chakra-ui/react"
...
function CreateAccount() {
    ...
    const handleSubmit=(e)=> {
        e.preventDefault();
         ...
         axios.post("https://geek-buting-clone.onrender.com/signup", data)
         .then((res)=>{
            // alert(res.data)
            if(res.data === "User already exists...Please try Login")
                {
                    setshow(true)
                    setTimeout(() => {
                       setshow(false)
                    ...
                    <Box h={{ sm: '30vh', md: '53vh', lg: '82vh' }} boxShadow='xl' w={['80%', '420px']} bg='white' p='35px' textAlign={'left'} m='auto' display={'inline-block'} mt='90px' borderRadius='8px'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <Input
                                ...
                                <br />
                                <Select name="role" id="role" p='20px' w="90%" mt='25px'
                                 type="password"
                                 onChange={handleData}>
